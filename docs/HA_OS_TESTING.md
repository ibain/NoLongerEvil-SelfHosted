...
Requires the fork add-on **0.0.22+** (upstream + PRs #39, #41–#44; see branch `addon`).

## Fork repos

- https://github.com/ibain/NoLongerEvil-SelfHosted (`addon`)
- https://github.com/ibain/NoLongerEvil-HomeAssistant (`main`)
...
5. Restart Mosquitto + forked add-on
6. **Settings → Devices & Services → MQTT → Configure** → reload if entities stale
...
2. Confirm add-on version is **0.0.22+**
