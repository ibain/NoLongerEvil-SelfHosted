...
def get_all_discovery_configs(
    ...
    *,
    ...
    Args:
        ...
        minimal_discovery: When True, expose only climate + Eco switch entities
    ...
    # Eco switch — always published for HomeKit remote control
