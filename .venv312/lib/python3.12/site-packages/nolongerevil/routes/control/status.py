...
def format_device_status(
    ...
    status = {
        ...
        "eco_active": is_eco_mode_enabled(device_values, structure_values),
        "manual_eco_all": is_structure_manual_eco(structure_values),
        "fan_running": is_fan_running(shared_values),
        "preset_mode": get_preset_mode(device_values, shared_values, structure_values),
